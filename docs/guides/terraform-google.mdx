...
lede: Use the official terraform-google-rune module to spin up a Rune edge node on a Compute Engine instance — instance, firewall, service account, optional static IP, cloud-init install, and an optional one-shot admin bootstrap.
---
