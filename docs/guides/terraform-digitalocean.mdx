...
lede: Use the official terraform-digitalocean-rune module to spin up a Rune edge node on a DigitalOcean droplet — droplet, firewall, cloud-init install, and an optional one-shot admin bootstrap.
---
