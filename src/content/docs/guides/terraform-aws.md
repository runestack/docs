...
description: Use the official terraform-aws-rune module to spin up a Rune edge node on an EC2 instance — instance, security group, IAM instance profile, optional Elastic IP, cloud-init install, and an optional one-shot admin bootstrap.
---
