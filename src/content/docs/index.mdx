...
:::tip[Status]
Rune is in active development. Release 1 (single-node MVP) is shipping. Multi-node (Raft consensus, agents) is in flight as Release 2. Track progress on [GitHub](https://github.com/runestack/rune).
:::
